...
var p = LevelScene.prototype = new creatine.Scene();
    ...
    p.initialize = function() {
        ...
        // initialize objects
        this.title = new createjs.Text('Level', '48px Verdana', '#FFFFFF');
        this.buttonBack = new createjs.Bitmap(loader.getResult('bmp_buttonmenu'));
